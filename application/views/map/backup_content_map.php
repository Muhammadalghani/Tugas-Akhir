	...
	<div id='selector_menu'>
		...
		var LayerActions = {
			...
			2016: function(){
				...
				$.getJSON('/map_data/data/2016.geojson', function(obj) {
				...
				info.update = function (props) {
				this._div.innerHTML = '<h4>Provinsi/<i>Province</i>:</h4>' +  (props ?
					'<b>' + props.NAME_1 + '</b><br /> Paddy Area:' + props.luas + ' Ha'
					: 'Hover over an area');
				};
			...
			2017: function(){
				map.removeLayer(geojson);
				$.getJSON('map_data/data/2017.geojson', function(obj) {
						geojson = L.geoJson(obj, {
						style: style,
						onEachFeature: onEachFeature
					}).addTo(map);
