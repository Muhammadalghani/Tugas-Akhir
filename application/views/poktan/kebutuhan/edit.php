...
<div class="container-fluid">
  ...
  <div class="largewidth" style="margin-bottom: 100px">
    ...
    <?php echo form_open('poktan/butuh_p/proses', 'class="form-horizontal"', array('id' => $butuhp->butuhk_id)); ?>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 form-group">
        <p>Gapoktan:</p>
        <select class="form-control input-default" name="gapoktan" id="gapoktan" disabled="disabled">
      ...
      <div class="col-sm-4 form-group">
        <p>Poktan:</p>
        <select class="form-control input-default" name="poktan" id="poktan" disabled="disabled">
          <!-- <option value="">-Pilih Kelompok Tani-</option>   -->
          <?php
          echo "<option value='" . $butuhp->nama_poktan . "'>" . $butuhp->nama_poktan . "</option>";
          ?>
        </select>
      ...
      <div class="col-sm-4 form-group">
        <p>Kecamatan:</p>
        <select class="form-control input-default" name="kecamatan" id="kecamatan" disabled="disabled">
          <!-- <option value="">-Pilih Kelompok Tani-</option>   -->
          <?php
          echo "<option value='" . $butuhp->nama_kecamatan . "'>" . $butuhp->nama_kecamatan . "</option>";
          ?>
        </select>
        <!-- <div id="loading2" style="margin-top: 15px;">
          <img src="<?php echo base_url(); ?>assets/images/loading.gif" width="25"> <small>Loading...</small>
      ...
      <div class="col-sm-4 form-group">
        <p>Desa:</p>
        <select class="form-control input-default" name="desa" id="desa" disabled="disabled">
          <!-- <option value="">-Pilih Kelompok Tani-</option>   -->
          <?php
          echo "<option value='" . $butuhp->nama_desa . "'>" . $butuhp->nama_desa . "</option>";
          ?>
        </select>
        <!-- <div id="loading2" style="margin-top: 15px;">
          <img src="<?php echo base_url(); ?>assets/images/loading.gif" width="25"> <small>Loading...</small>
