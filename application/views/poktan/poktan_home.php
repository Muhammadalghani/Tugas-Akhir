...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php $this->load->view('poktan/menu_poktan'); ?>
  ...
  <!-- Topbar -->
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="margin-bottom: 5px">
...
<li class="nav-item dropdown no-arrow">
  <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Gabungan Kelompok Tani">
    <i class="fas fa-users fa-xl fa-fw mr-2 text-gray-400"></i>
      <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="text-transform: uppercase;">
        <?php 
          foreach ($data_diri as $row) { ?>
            <?php echo $row->nama_gapoktan; ?>
        <?php } ?>
        
        <!-- <?php echo $this->session->userdata('id_login'); ?> -->
      </span>
    <!-- <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"> -->
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Kelompok Tani">
          <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="text-transform: uppercase;">
            <?php 
              foreach ($data_diri as $row) { ?>
  ...
  <?php  $this->load->view($content);?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          ...
          <span style="color: black;"><strong>Copyright © 2022 </strong>Sistem Informasi Manajemen Pupuk Bersubsidi oleh<a href="https://www.instagram.com/muhammad_alghani_/"> Muhammad Al Ghani</a>. Teknik Sistem dan Informatika Pertanian, Departemen Teknik Mesin dan Biosistem - IPB.</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
