...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php $this->load->view('pengecer/menu_pengecer'); ?>
  ...
  <?php  $this->load->view($content);?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          ...
          <span style="color: black;"><strong>Copyright © 2022 </strong>Sistem Informasi Manajemen Pupuk Bersubsidi oleh<a href="https://instagram.com/kawan.senja"> Muhammad Al Ghani</a>. Teknik Sistem dan Informatika Pertanian, Departemen Teknik Mesin dan Biosistem - IPB.</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
