...
<head>
    ...
    <title><?= $title; ?> | Pengadaan Pupuk</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Pengadaan Pupuk</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Pupuk</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Jenis Pupuk</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Pupuk</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright 2022 &copy; Sistem Informasi Manajemen Pupuk Bersubsidi oleh &bull; by <?= anchor('https://www.instagram.com/muhammad_alghani_/', 'Muhammad Al Ghani'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
