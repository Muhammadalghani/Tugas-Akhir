...
<div class="container-fluid">
  ...
  <div class="largewidth" style="margin-bottom: 100px">
    <h4 class="formheader">Input Data Kebutuhan Pupuk Bersubsidi (RDKK)</h4>
    <?php echo form_open('admin/butuh_p/proses'); ?>
    <div class="row">
      <div class="col-sm-4 form-group">
        <p>Tahun:</p>
        <select class="form-control input-default" name="tahun_id" id="tahun_id" required="required" oninvalid="this.setCustomValidity('Silahkan dipilih dahulu!')" oninput="setCustomValidity('')">
      ...
      <div class="col-sm-4 form-group">
        <p>Gapoktan:</p>
        <select class="form-control input-default" name="gapoktan" id="gapoktan" required="required" oninvalid="this.setCustomValidity('Silahkan dipilih dahulu!')" oninput="setCustomValidity('')">
      ...
      <div class="col-sm-4 form-group">
        <p>Poktan:</p>
        <select class="form-control input-default" name="poktan" id="poktan" required="required" oninvalid="this.setCustomValidity('Silahkan dipilih dahulu!')" oninput="setCustomValidity('')">
      ...
      <div class="col-sm-4 form-group">
        <!-- invisible -->
        <p>Kecamatan:</p>
        <select class="form-control input-default" name="kecamatan" id="kecamatan" required="required" oninvalid="this.setCustomValidity('Silahkan dipilih dahulu!')" oninput="setCustomValidity('')">
      ...
      <div class="col-sm-4 form-group">
        <!-- invisible -->
        <p>Desa:</p>
        <select class="form-control input-default" name="desa" id="desa" required="required" oninvalid="this.setCustomValidity('Silahkan dipilih dahulu!')" oninput="setCustomValidity('')">
    ...
    <div class="row">
      <div class="text-left col-sm-4 form-group has-feedback">
        <p>Masa Tanam I:</p>
        <input type="number" step="any" name="lt1" placeholder="(Hektare)" value="" oninvalid="this.setCustomValidity('Tolong Masukkan Angka!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" class="form-control" required="required">
        <i class="glyphicon glyphicon-user form-control-feedback glyphiconalign"></i>
      </div>
      <div class="text-left col-sm-4 form-group has-feedback">
        <p>Masa Tanam II:</p>
        <input type="number" step="any" name="lt2" placeholder="(Hektare)" value="" oninvalid="this.setCustomValidity('Tolong Masukkan Angka!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" class="form-control" required="required">
        <i class="glyphicon glyphicon-user form-control-feedback glyphiconalign"></i>
      </div>
      <div class="text-left col-sm-4 form-group has-feedback">
        <p>Masa Tanam III:</p>
        <input type="number" step="any" name="lt3" placeholder="(Hektare)" value="" oninvalid="this.setCustomValidity('Tolong Masukkan Angka!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" class="form-control" required="required">
        <i class="glyphicon glyphicon-user form-control-feedback glyphiconalign"></i>
      </div>
    </div>
