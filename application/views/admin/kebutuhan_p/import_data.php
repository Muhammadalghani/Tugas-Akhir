      ...
      <!-- <form role="form" class="largewidth"> -->
        ...
        <div class="row">
          <div class="col-sm-4 form-group">
            ...
            <div class="col-sm-4 form-group">
            <p>Gapoktan:</p>
              <select class="form-control input-default" name="gapoktan" id="gapoktan" required="required">
        ...
        <div class="col-sm-4 form-group">
            <p>Poktan:</p>
              <select class="form-control input-default" name="poktan" id="poktan" required="required">
