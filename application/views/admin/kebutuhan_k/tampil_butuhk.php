	<div>
		<!-- <a class='btn btnprimary ' href="<?php echo site_url('admin/butuh_k/add')?>">Tambah Data</a> -->
...
<div class="card mb-3">
	<div class="card-header py-3">
      ...
      <i class="fas fa-table center" ></i>
		Data Rekapitulasi RDKK (Rencana Definitif Kelompok Kerja) Tingkat Kecamatan
		<?php 
    $tahun = @$_GET['tahun'];
    if($tahun == "1"){
      echo "Tahun 2016";
      ...
      <div class="col offset-4">
        ...
        <script>
          function send_value(val)
           {
                window.location = "<?php echo base_url("admin/butuh_k/by_tahun")?>?tahun="+val;
			...
			<table id="example" class="table table-bordered" width="100%" cellspacing="0" style="font-size: 12px">
				...
				<tbody>
					...
					<?php 
						...
						<td><?php echo $row->nama_kecamatan; ?></td> <!-- >> Nama Kecamatan -->
						
						<td><?php echo $row->luas_tanam; ?></td>	 <!-- >>Luas Tanam 1-->
						<td><?php echo $row->luas_tanam; ?></td>	 <!-- >>Luas Tanam 2-->
						<td><?php echo $row->luas_tanam; ?></td>	 <!-- >>Luas Tanam 3-->
