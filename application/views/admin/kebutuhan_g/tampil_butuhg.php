...
<div class="card mb-3">
	<div class="card-header py-3">
      ...
      <i class="fas fa-table center" ></i>
		Data Rekapitulasi RDKK (Rencana Definitif Kelompok Kerja) Tingkat Gapoktan
		<?php 
    $tahun = @$_GET['tahun'];
    if($tahun == "1"){
      echo "Tahun 2016";
      ...
      <div class="col offset-4">
        ...
        <script>
          function send_value(val)
           {
                window.location = "<?php echo base_url("admin/butuh_g/by_tahun")?>?tahun="+val;
               // Here page.php is the page where you want to send the value it may be the name of same page.
           }   
        </script>
        </div>
        <!-- <div class="col-6">
          <a class='btn btn-primary ' href="<?php echo site_url('admin/butuh_g/add')?>">Tambah Data</a>
        </div> -->
        </div>
	<!-- 		<div>
		<a class='btn btn-primary ' href="<?php echo site_url('admin/butuh_k/add')?>">Tambah Data</a>
	...
	<div class="card-body">
		<div class="table-responsive">
			<table id="example" class="table table-bordered" width="100%" cellspacing="0" style="font-size: 12px">
				<thead align="middle" >
					<tr>
						<th scope="col" rowspan="3" >No</th>
						<th scope="col" rowspan="3" >Gapoktan</th>
						<th scope="col" rowspan="2" colspan="3">Luas<br>Tanam(Ha)</th>
				...
				<tbody>
					...
					<?php 
						...
						<td><?php echo $row->nama_gapoktan; ?></td> <!-- >> Nama Kecamatan -->
						
						<td><?php echo $row->luas_tanam; ?></td>	 <!-- >>Luas Tanam -->
...
<!-- 						<td>
							<div class="text-center">
								...
								<a href="<?php echo site_url('admin/butuh_k/lihat/'.$row->butuhk_id)?>">
