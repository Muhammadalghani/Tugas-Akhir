<div class="card mb-3">
	...
	<div>
		<a class='btn btn-primary' href="<?php echo site_url('admin/distributors/add')?>">Tambah Data</a>
					...
					<?php 
						...
						foreach ($data as $d => $row) {?>
							...
							<td><div class="text-center"><?php echo $No++; ?></div></td>
						 	...
						 	<td><div class="text-center"><?php echo $row->tahun_berdiri; ?></div></td>
						 	<td><?php echo $row->no_hp; ?></td>
							<td><div class="text-center">
								<a href="<?php echo site_url('admin/distributors/edit/'.$row->distributor_id)?>">
								<i class="fas fa-edit" style="color: #03ad30"" title="Edit"></i></a>&nbsp&nbsp
								
								<a href="<?php echo site_url('admin/distributors/del/'.$row->distributor_id)?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')">
