...
<div class="container-fluid">
    ...
    <div class="largewidth" style="margin-bottom: 100px">
        <h4 class="formheader">Input Data Pupuk Masuk<br>(Level Admin)</h4>
        <?php echo form_open('admin/masuk_p/proses'); ?>
        <div class="row">
            ...
            <div class="col-sm-4 form-group">
                <!-- invisible -->
                <p>Distributor:</p>
                <select class="form-control input-default" name="distributor" id="distributor">
                    <option value="">-Pilih Distributor-</option>
                    <?php
                    foreach ($get_distributor as $row) {
            ...
            <div class="col-sm-4 form-group">
                <!-- invisible -->
                <p>Pengecer:</p>
                <select class="form-control input-default" name="pengecer" id="pengecer">
                    <option value="">-Pilih Pengecer-</option>
                    <?php
                    foreach ($get_pengecer as $row) {
            ...
            <div class="col-sm-4 form-group">
                <!-- invisible -->
                <p>Kecamatan:</p>
                <select class="form-control input-default" name="kecamatan_id" id="kecamatan_id">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <a class="btn btn-default" href="<?php echo base_url('admin/masuk_p') ?>" role="button">Kembali</a>
            </div>
        </div>
...
<script>
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
        ...
        $("#distributor").change(function() { // Ketika user mengganti atau memilih data provinsi
            ...
            $.ajax({
                type: "POST", // Method pengiriman data bisa dengan GET atau POST
                url: "<?php echo base_url("index.php/admin/masuk_p/listPengecer"); ?>", // Isi dengan url/path file php yang dituju
                data: {
                ...
                success: function(response) { // Ketika proses pengiriman berhasil
                    ...
                    // set isi dari combobox kota
                    // lalu munculkan kembali combobox kotanya
                    $("#pengecer").html(response.list_pengecer).show();
                    // }, 3000);
                },
                error: function(xhr, ajaxOptions, thrownError) { // Ketika ada error
                    alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError); // Munculkan alert error
...
<!-- <script>
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
        ...
        $("#pengecer").change(function() { // Ketika user mengganti atau memilih data provinsi
            $("#kecamatan").hide(); // Sembunyikan dulu combobox kota nya
            $("#loading3").show(); // Tampilkan loadingnya

            $.ajax({
                type: "POST", // Method pengiriman data bisa dengan GET atau POST
                url: "<?php echo base_url("index.php/admin/masuk_p/listKecamatan"); ?>", // Isi dengan url/path file php yang dituju
                data: {
                    pengecer_id: $("#pengecer").val()
                }, // data yang akan dikirim ke file yang dituju
                dataType: "json",
                beforeSend: function(e) {
                    if (e && e.overrideMimeType) {
