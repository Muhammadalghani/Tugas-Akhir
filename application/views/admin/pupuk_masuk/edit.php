...
<div class="container-fluid">
    ...
    <div class="largewidth" style="margin-bottom: 100px">
        <h4 class="formheader">Update Data Pupuk Masuk (Level Admin)</h4>
        <?php echo form_open('admin/masuk_p/proses', 'class="form-horizontal"', array('id' => $pterima->pterima_id)); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 form-group">
                <p>Bulan:</p>
                <select class="form-control input-default" name="bulan_id" id="bulan_id">
            ...
            <div class="col-sm-4 form-group">
                <p>Jenis Pupuk:</p>
                <select class="form-control input-default" name="pupuk_id" id="pupuk_id">
