                        ...
                        <div class="col-8">
                            ...
                            <script>
                                function send_value(val) {
                                    window.location = "<?php echo base_url("dinas/pupukterima/by_bulan") ?>?bulan=" + val;
                                }
                            </script>
                        </div>
                        <!-- <div class="col">
                            ...
                            <tr>
                                ...
                                <!-- <td> -->
                                    <!-- <div class="text-center"> -->
                                        <!-- <a href="<?php echo site_url('admin/masuk_p/edit/' . $row->pterima_id) ?>"> -->
                                            <!-- <i class="fas fa-edit" style="color: #ffa500" title="Edit"></i></a> -->

                                        <!-- <a href="<?php echo site_url('admin/masuk_p/del/' . $row->pterima_id) ?>"> -->
